 ...
 * 
 * <p>This is a {@link FunctionalInterface} whose functional
 * method is {@link #apply(Object, Object, Object)}.</p>
 * 
...
public interface TriFunction<T, U, V, R> {
	 ...
	 * input, and then applies the <code>after</code> function to the result.
	 * 
	 * <p>If evaluation of either function throws an exception,
	 * it is relayed to the caller of the composed function.</p>
	 * 
