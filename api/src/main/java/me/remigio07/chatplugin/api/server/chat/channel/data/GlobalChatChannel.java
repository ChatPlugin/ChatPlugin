...
/**
 * Represents a global (server-wide) {@link ChatChannel}'s data.
 * 
 * <p><strong>Type:</strong> {@link ChatChannelType#GLOBAL}</p>
 */
public class GlobalChatChannel extends ChatChannelData {
	
	/**
	 * Constructs a new global chat channel.
	 */
