 ...
 * 
 * @see ChatPluginServerPlayer#switchChannel(ChatChannel)
 */
public class ChatChannelSwitchEvent extends ChatChannelEvent {
	
	/**
	 * Constructs a new channel switch event.
	 * 
	 * @param player Player involved
	 * @param channel Channel involved
	 */
	public ChatChannelSwitchEvent(ChatPluginServerPlayer player, ChatChannel<? extends ChatChannelData> channel) {
