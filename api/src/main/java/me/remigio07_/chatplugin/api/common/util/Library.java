...
public enum Library {
	...
	JAR_RELOCATOR("JAR Relocator", "me.remigio07_.jarrelocator.JarRelocator", null, "https://github.com/Remigio07/JAR-Relocator/releases/download/v1.6/JAR-Relocator-1.6.jar", "jar-relocator.jar"),
	 ...
	 * 
	 * <p><strong>Value:</strong> "me.remigio07_.chatplugin.common.lib."</p>
	 */
	public static final String PREFIX = "me.remigio07_.chatplugin.common.lib.";
