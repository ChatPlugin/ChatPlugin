...
public abstract class ChatPluginFabricIntegration<T extends ChatPluginIntegration> extends BaseIntegration<T> {
	
	public ChatPluginFabricIntegration(IntegrationType<T> type) {
		super(type);
	}
