...
public class DummyScoreboardManager extends ScoreboardManager {
	...
	@Override
	public Scoreboard.Builder createScoreboardBuilder(String id, boolean displayOnlyOneNumberEnabled, int displayOnlyOneNumberValue, List<PlaceholderType> placeholderTypes) {
		return null;
	}
