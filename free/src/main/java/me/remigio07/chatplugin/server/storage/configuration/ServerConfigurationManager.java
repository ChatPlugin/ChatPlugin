...
import me.remigio07.chatplugin.common.storage.configuration.BaseConfigurationManager;
...
public class ServerConfigurationManager extends BaseConfigurationManager {
	...
	public void load() throws ChatPluginManagerException {
		try {
			...
			putConfiguration(new ConfigurationImpl(ConfigurationType.CONFIG));
			
			putConfiguration(new ConfigurationImpl(ConfigurationType.MESSAGES));
			
			putConfiguration(new ConfigurationImpl(ConfigurationType.RANKS));
			putConfiguration(new ConfigurationImpl(ConfigurationType.CHAT));
			putConfiguration(new ConfigurationImpl(ConfigurationType.TABLISTS));
			putConfiguration(new ConfigurationImpl(ConfigurationType.ACTIONBARS));
			putConfiguration(new ConfigurationImpl(ConfigurationType.ADS));
			putConfiguration(new ConfigurationImpl(ConfigurationType.F3_SERVER_NAMES));
			putConfiguration(new ConfigurationImpl(ConfigurationType.JOIN_QUIT_MODULES));
			
			putConfiguration(new ConfigurationImpl(ConfigurationType.MAIN_GUI));
			putConfiguration(new ConfigurationImpl(ConfigurationType.LANGUAGES_GUI));
			putConfiguration(new ConfigurationImpl(ConfigurationType.CHAT_COLOR_GUI));
			putConfiguration(new ConfigurationImpl(ConfigurationType.EMOJIS_TONE_GUI));
			putConfiguration(new ConfigurationImpl(ConfigurationType.PLAYER_INFO_GUI));
			putConfiguration(new ConfigurationImpl(ConfigurationType.PREFERENCES_GUI));
			
			if (ChatPlugin.getInstance().isPremium()) {
				putConfiguration(new ConfigurationImpl(ConfigurationType.DEFAULT_SCOREBOARD));
				putConfiguration(new ConfigurationImpl(ConfigurationType.BOSSBARS));
				
				putConfiguration(new ConfigurationImpl(ConfigurationType.BANLIST_GUI));
				putConfiguration(new ConfigurationImpl(ConfigurationType.WARNLIST_GUI));
				putConfiguration(new ConfigurationImpl(ConfigurationType.MUTELIST_GUI));
				putConfiguration(new ConfigurationImpl(ConfigurationType.VIOLATIONS_GUI));
				putConfiguration(new ConfigurationImpl(ConfigurationType.PLAYER_PUNISHMENTS_GUI));
				putConfiguration(new ConfigurationImpl(ConfigurationType.PLAYER_VIOLATIONS_GUI));
				putConfiguration(new ConfigurationImpl(ConfigurationType.VIOLATIONS_ICONS));
				
				putConfiguration(new ConfigurationImpl(ConfigurationType.MOTD));
				
				putConfiguration(new ConfigurationImpl(ConfigurationType.DISCORD_INTEGRATION));
				putConfiguration(new ConfigurationImpl(ConfigurationType.TELEGRAM_INTEGRATION));
			}
	...
	public void addMessagesDefaults(boolean forceAdd) throws IOException {
		...
		messages.addDefault("commands.version", "{pfx} &aRunning &c&lChat&f&lPlugin {0} &fv{1} &aby &9Remigio07 &aon &f{2} &f{3}&a.");
	...
	public void addRanksDefaults(boolean forceAdd) throws IOException {
		...
		if (fileMissing) {
			...
			ranks.addDefault("ranks.default.tag.name-color", "&f");
			...
			ranks.addDefault("ranks.vip.tag.name-color", "&f");
	...
	public void addChatDefaults(boolean forceAdd) throws IOException {
		...
		chat.addDefault("chat.placeholder-types", Arrays.asList("PLAYER", "SERVER"));
	...
	public void addBossbarsDefaults(boolean forceAdd) throws IOException {
		...
		bossbars.addDefault("bossbars.settings.loading-bossbar.style", "PROGRESS");
	...
	public void addActionbarsDefaults(boolean forceAdd) throws IOException {
		...
		actionbars.addDefault("actionbars.settings.enabled", true); // TODO: is Sponge pre-1.12 supported?
	...
	public void addF3ServerNamesDefaults(boolean forceAdd) throws IOException {
		...
		f3ServerNames.addDefault("f3-server-names.settings.enabled", !Environment.isSponge());
	...
	public void addMoTDDefaults(boolean forceAdd) throws IOException {
		...
		motd.addDefault("motd.unknown-player.icon-url", "https://remigio07.me/chatplugin/assets/motd/chatplugin-server-icon.png");
		...
		motd.addDefault("motd.stored-player.icon-url", "https://remigio07.me/chatplugin/assets/motd/chatplugin-server-icon.png");
		...
		motd.addDefault("motd.banned-player.icon-url", "https://remigio07.me/chatplugin/assets/motd/banned-player-icon.png");
		...
		motd.addDefault("motd.outdated-version.icon-url", "https://remigio07.me/chatplugin/assets/motd/outdated-version-icon.png");
