...
import me.remigio07.chatplugin.server.chat.channel.ChatChannelsManagerImpl;
import me.remigio07.chatplugin.server.chat.log.DummyChatLogManager;
import me.remigio07.chatplugin.server.fabric.integration.FabricIntegrationManager;
import me.remigio07.chatplugin.server.fabric.manager.FabricChatManager;
import me.remigio07.chatplugin.server.fabric.manager.FabricEventManager;
import me.remigio07.chatplugin.server.fabric.manager.FabricF3ServerNameManager;
import me.remigio07.chatplugin.server.fabric.manager.FabricPlayerManager;
...
import me.remigio07.chatplugin.server.join_quit.ServerLinkManagerImpl;
...
public class ChatPluginServerManagers extends ChatPluginManagers {
	...
	public void loadManagers() throws ChatPluginManagerException {
		...
		addManager(ServerLinkManager.class, new ServerLinkManagerImpl());
		addManager(AccountCheckManager.class, new DummyAccountCheckManager());
		addManager(PlayerManager.class, Environment.isBukkit() ? new BukkitPlayerManager() : Environment.isSponge() ? new SpongePlayerManager() : new FabricPlayerManager());
		...
		addManager(ChatManager.class, Environment.isBukkit() ? new BukkitChatManager() : Environment.isSponge() ? new SpongeChatManager() : new FabricChatManager());
		...
		addManager(F3ServerNameManager.class, Environment.isBukkit() ? new BukkitF3ServerNameManager() : Environment.isSponge() ? new SpongeF3ServerNameManager() : new FabricF3ServerNameManager());
