...
package me.remigio07_.chatplugin.server.gui;
...
import me.remigio07_.chatplugin.api.server.gui.FillableGUILayout;
import me.remigio07_.chatplugin.api.server.gui.GUI;
import me.remigio07_.chatplugin.api.server.gui.GUILayout;
import me.remigio07_.chatplugin.api.server.gui.GUIManager;
import me.remigio07_.chatplugin.api.server.gui.Icon;
import me.remigio07_.chatplugin.api.server.gui.OpenActions;
import me.remigio07_.chatplugin.api.server.gui.PerPlayerGUI;
import me.remigio07_.chatplugin.api.server.gui.SinglePageGUILayout.Builder;
...
public class DummyGUIManager extends GUIManager {
	...
	@Override
	public Builder createSinglePageGUILayoutBuilder(String id, int rows, OpenActions openActions, SoundAdapter clickSound, Map<Language, String> titles) {
		return null;
	}
