...
public class NegativityIntegration extends ChatPluginSpongeIntegration<AnticheatIntegration> implements AnticheatIntegration {
	...
	protected void loadAPI() {
		try {
			Class.forName("com.elikill58.negativity.api.events.EventManager").getMethod("registerEvent", Class.forName("com.elikill58.negativity.api.events.Listeners")).invoke(null, Class.forName("me.remigio07_.chatplugin.server.sponge.integration.anticheat.negativity.NegativityListener").newInstance());
