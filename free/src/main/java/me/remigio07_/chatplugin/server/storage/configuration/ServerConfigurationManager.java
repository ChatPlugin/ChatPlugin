...
package me.remigio07_.chatplugin.server.storage.configuration;
...
import me.remigio07_.chatplugin.api.common.util.VersionChange;
...
public class ServerConfigurationManager extends ConfigurationManager {
	...
	public void addMessagesDefaults(boolean forceAdd) throws IOException {
		...
		messages.addDefault("commands.version", "{pfx} &aRunning &c&lChat&f&lPlugin {0} &fv{1} &aby &9Remigio07_ &aon &f{2} {3}&a.");
		...
		messages.addDefault("mute.command-usage.permanentmute", "{pfx} &cThe syntax is wrong. Usage: &f{0}&c. Additional flags:\n&f&l-silent &8- &emake it silent: only the Staff will be notified.\n&f&l-type &8- &ealternate mute scope (default is &f{1}&e).");
